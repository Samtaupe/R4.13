...
function init() {
	...
	frontCam = new THREE.OrthographicCamera(
        ...
        viewSize / 2, -viewSize / 2,
        -1000, 1000 );
    frontCam.position.set( 0, 0, -viewSize / 2 );
    ...
    sideCam = new THREE.OrthographicCamera(
        ...
        viewSize / 2, -viewSize / 2,
        -1000, 1000 );
    sideCam.position.set( -viewSize / 2, 0, 0 );
...
function render() {
    ...
    frontCam.position.z -= viewSize / 2;
    frontCam.lookAt( cameraControls.target );
    renderer.setViewport( 0, 0.5*canvasHeight, 0.25*canvasWidth, 0.25*canvasHeight );
    renderer.render( scene, frontCam );

    // side view
    sideCam.position.copy( cameraControls.target );
    sideCam.position.x -= viewSize / 2;
    sideCam.lookAt( cameraControls.target );
    renderer.setViewport( 0.75*canvasWidth, 0, 0.25*canvasWidth, 0.25*canvasHeight );

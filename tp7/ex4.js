...
var groundTexture; // Declare the variable globally
...
function fillScene() {
    ...
    //var groundTexture = new THREE.TextureLoader().load('/../textures/grass512x512.jpg');
    groundTexture = new THREE.TextureLoader().load('/../textures/water.jpg');
...
function render() {
    ...
    // Simulate water flow by incrementing the offset

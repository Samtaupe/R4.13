 ...
 *
 */
export const TeapotGeometry = function (size, segments, bottom, lid, body, fitLid, blinn) {
	...
	triangle.setIndex(new THREE.BufferAttribute(indices, 1));
	triangle.setAttribute('position', new THREE.BufferAttribute(vertices, 3));
	triangle.setAttribute('normal', new THREE.BufferAttribute(normals, 3));
	triangle.setAttribute('uv', new THREE.BufferAttribute(uvs, 2));

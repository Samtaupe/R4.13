...
function drawDrinkingBird() {
	...
	var eyeMaterial = new THREE.MeshLambertMaterial({color: 0x00ff00} );

	var noseMaterial = new THREE.MeshLambertMaterial({color: 0x0000ff} );
	...
	var glassMaterial = new THREE.MeshPhongMaterial( { color: 0xFFFFFF, shininess: 100 , transparent: true, opacity : 0.7} );
	...
	// base
	cube = new THREE.Mesh(
		new THREE.BoxGeometry( 20+64+110, 4, 2*77+12, bevelRadius ), footMaterial );
	...
	// feet
	cube = new THREE.Mesh(
		new THREE.BoxGeometry( 20+64+110, 52, 6, bevelRadius ), footMaterial );
	cube.position.x = -45;	// (20+32) - half of width (20+64+110)/2
	...
	cube = new THREE.Mesh(
		new THREE.BoxGeometry( 64, 104, 6, bevelRadius ), footMaterial );
	...
	// legs
	cube = new THREE.Mesh(
		new THREE.BoxGeometry( 60, 282+4, 4, bevelRadius ), legMaterial );
	cube.position.x = 0;	// centered on origin along X
	...
	var nose = new THREE.Mesh(
		new THREE.CylinderGeometry(1, 5, 16), noseMaterial);
		nose.position.x = -60;
		nose.rotation.z = 45*Math.PI/180;
		nose.position.y = -10;
	sphere.add(nose);
	// hat
	cylinder = new THREE.Mesh(

...
function init() {
	...
	const floor = new THREE.BoxGeometry(100, 10, 50 );
	...
	const wallMaterial = new THREE.MeshStandardMaterial( {map: textureWall, roughness:0, metalness: 0, shadowSide: THREE.DoubleSide} );
